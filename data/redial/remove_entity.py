...
with open('/root/autodl-tmp/LINK-main/data/redial/entity2id.json', encoding='utf-8') as f:
...
src_files = ['/root/autodl-tmp/LINK-main/data/redial/test_data_dbpedia_raw.jsonl', '/root/autodl-tmp/LINK-main/data/redial/valid_data_dbpedia_raw.jsonl', '/root/autodl-tmp/LINK-main/data/redial/train_data_dbpedia_raw.jsonl']
tgt_files = ['/root/autodl-tmp/LINK-main/data/redial/test_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/data/redial/valid_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/data/redial/train_data_dbpedia.jsonl']
