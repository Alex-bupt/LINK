...
if __name__ == '__main__':
    ...
    process('/root/autodl-tmp/LINK-main/src/data/redial/valid_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/src/data/redial/valid_data_processed.jsonl', item_set)
    process('/root/autodl-tmp/LINK-main/src/data/redial/test_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/src/data/redial/test_data_processed.jsonl', item_set)
    process('/root/autodl-tmp/LINK-main/src/data/redial/train_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/src/data/redial/train_data_processed.jsonl', item_set)

    with open('/root/autodl-tmp/LINK-main/src/data/redial/item_ids.json', 'w', encoding='utf-8') as f:
