...
if __name__ == '__main__':
    with open('/root/autodl-tmp/LINK-main/src/data/redial/entity2id.json', 'r', encoding='utf-8') as f:
    ...
    process('/root/autodl-tmp/LINK-main/src/data/redial/valid_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/src/data/redial/valid_data_processed.jsonl', movie_set)
    process('/root/autodl-tmp/LINK-main/src/data/redial/test_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/src/data/redial/test_data_processed.jsonl', movie_set)
    process('/root/autodl-tmp/LINK-main/src/data/redial/train_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/src/data/redial/train_data_processed.jsonl', movie_set)

    with open('/root/autodl-tmp/LINK-main/src/data/redial/movie_ids.json', 'w', encoding='utf-8') as f:
