...
def kg2id(kg):
    ...
    with open('/root/autodl-tmp/LINK-main/data/inspired/relation_set.json', encoding='utf-8') as f:
...
all_item = set()
file_list = [
    '/root/autodl-tmp/LINK-main/data/inspired/test.jsonl',
    '/root/autodl-tmp/LINK-main/data/inspired/dev.jsonl',
    '/root/autodl-tmp/LINK-main/data/inspired/train.jsonl',
]
...
with open('/root/autodl-tmp/LINK-main/data/inspired/dbpedia_subkg.json', 'w', encoding='utf-8') as f:
    json.dump(subkg, f, ensure_ascii=False)
with open('/root/autodl-tmp/LINK-main/data/inspired/entity2id.json', 'w', encoding='utf-8') as f:
    json.dump(entity2id, f, ensure_ascii=False)
with open('/root/autodl-tmp/LINK-main/data/inspired/relation2id.json', 'w', encoding='utf-8') as f:
