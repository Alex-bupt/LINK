...
with open('/root/autodl-tmp/LINK-main/data/inspired/entity2id.json', encoding='utf-8') as f:
...
src_files = ['/root/autodl-tmp/LINK-main/data/inspired/test.jsonl', '/root/autodl-tmp/LINK-main/data/inspired/dev.jsonl', '/root/autodl-tmp/LINK-main/data/inspired/train.jsonl']
tgt_files = ['/root/autodl-tmp/LINK-main/data/inspired/test_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/data/inspired/valid_data_dbpedia.jsonl', '/root/autodl-tmp/LINK-main/data/inspired/train_data_dbpedia.jsonl']
